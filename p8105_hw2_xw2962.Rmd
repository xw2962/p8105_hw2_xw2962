...
Dataset "mci_baseline_df" has `r ncol(mci_baseline_df)` variables: `r colnames(mci_baseline_df)`. In this dataset, there are `r nrow(mci_baseline_df_noncleaned)` participants. 
Of these, `r nrow(mci_baseline_df)` devlops MCI. 
The average baseline age is `r mean(mci_baseline_df$age_at_onset)`. 
